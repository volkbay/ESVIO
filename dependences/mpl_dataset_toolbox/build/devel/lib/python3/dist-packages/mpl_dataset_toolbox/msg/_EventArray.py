...
"""autogenerated by genpy from mpl_dataset_toolbox/EventArray.msg. Do not edit."""
import codecs
import sys
...
import genpy
import mpl_dataset_toolbox.msg
import std_msgs.msg

class EventArray(genpy.Message):
  _md5sum = "5e8beee5a6c107e504c2e78903c224b8"
  _type = "mpl_dataset_toolbox/EventArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This message is copied from Prophesee ROS Wrapper.
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint32','uint32','mpl_dataset_toolbox/Event[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = mpl_dataset_toolbox.msg.Event()
        _x = val1
        start = end
        end += 4
