...
if(mpl_dataset_toolbox_CONFIG_INCLUDED)
  return()
endif()
set(mpl_dataset_toolbox_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(mpl_dataset_toolbox_SOURCE_PREFIX /catkin_ws_dvs/src/mpl_dataset_toolbox)
  set(mpl_dataset_toolbox_DEVEL_PREFIX /catkin_ws_dvs/src/mpl_dataset_toolbox/build/devel)
  set(mpl_dataset_toolbox_INSTALL_PREFIX "")
  set(mpl_dataset_toolbox_PREFIX ${mpl_dataset_toolbox_DEVEL_PREFIX})
else()
  set(mpl_dataset_toolbox_SOURCE_PREFIX "")
  set(mpl_dataset_toolbox_DEVEL_PREFIX "")
  set(mpl_dataset_toolbox_INSTALL_PREFIX /usr/local)
  set(mpl_dataset_toolbox_PREFIX ${mpl_dataset_toolbox_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'mpl_dataset_toolbox' is deprecated")
...
set(mpl_dataset_toolbox_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/catkin_ws_dvs/src/mpl_dataset_toolbox/build/devel/include;/catkin_ws_dvs/src/mpl_dataset_toolbox/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(mpl_dataset_toolbox_INCLUDE_DIRS "")
  set(_include_dirs "/catkin_ws_dvs/src/mpl_dataset_toolbox/build/devel/include;/catkin_ws_dvs/src/mpl_dataset_toolbox/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "https://star-datasets.github.io/vector/download/ " STREQUAL " ")
    set(_report "Check the website 'https://star-datasets.github.io/vector/download/' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Ling Gao <gaoling@shanghaitech.edu.cn>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${mpl_dataset_toolbox_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mpl_dataset_toolbox' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'mpl_dataset_toolbox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws_dvs/src/mpl_dataset_toolbox/${idir}'.  ${_report}")
    endif()
    _list_append_unique(mpl_dataset_toolbox_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND mpl_dataset_toolbox_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND mpl_dataset_toolbox_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT mpl_dataset_toolbox_NUM_DUMMY_TARGETS)
      set(mpl_dataset_toolbox_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mpl_dataset_toolbox::wrapped-linker-option${mpl_dataset_toolbox_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mpl_dataset_toolbox_NUM_DUMMY_TARGETS "${mpl_dataset_toolbox_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mpl_dataset_toolbox::wrapped-linker-option${mpl_dataset_toolbox_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mpl_dataset_toolbox_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /catkin_ws_dvs/src/mpl_dataset_toolbox/build/devel/lib;/catkin_ws_dvs/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(mpl_dataset_toolbox_LIBRARY_DIRS ${lib_path})
      list(APPEND mpl_dataset_toolbox_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'mpl_dataset_toolbox'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND mpl_dataset_toolbox_LIBRARIES ${lib})
    endif()
  endif()
...
set(mpl_dataset_toolbox_EXPORTED_TARGETS "mpl_dataset_toolbox_generate_messages_cpp;mpl_dataset_toolbox_generate_messages_eus;mpl_dataset_toolbox_generate_messages_lisp;mpl_dataset_toolbox_generate_messages_nodejs;mpl_dataset_toolbox_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${mpl_dataset_toolbox_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 mpl_dataset_toolbox_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${mpl_dataset_toolbox_dep}_FOUND)
      find_package(${mpl_dataset_toolbox_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mpl_dataset_toolbox_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(mpl_dataset_toolbox_INCLUDE_DIRS ${${mpl_dataset_toolbox_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(mpl_dataset_toolbox_LIBRARIES ${mpl_dataset_toolbox_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${mpl_dataset_toolbox_dep}_LIBRARIES})
  _list_append_deduplicate(mpl_dataset_toolbox_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(mpl_dataset_toolbox_LIBRARIES ${mpl_dataset_toolbox_LIBRARIES})

  _list_append_unique(mpl_dataset_toolbox_LIBRARY_DIRS ${${mpl_dataset_toolbox_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(mpl_dataset_toolbox_EXPORTED_TARGETS ${${mpl_dataset_toolbox_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "mpl_dataset_toolbox-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${mpl_dataset_toolbox_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
